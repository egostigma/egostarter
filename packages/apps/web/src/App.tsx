...
import { CompReact, CompNative } from '@egostarter/components';
    ...
    <div className="App">
      <header className="App-header">
        ...
        <p className="body">
          ...
          <code className="file">packages/components/src/CompReact/CompReact.tsx</code>
          <code className="file">packages/components/src/CompNative/CompNative.tsx</code>
        </p>
